...
import { FeatureToggles, UserProfile, UserRole } from '../types';
      ...
      >
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="p-3 shrink-0">
            <button className="w-full bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100/80 dark:hover:bg-slate-800 text-left px-3 py-2 rounded-xl flex items-center justify-between transition text-xs cursor-pointer">
              <div className="flex items-center space-x-2 truncate">
                <div className="w-6 h-6 rounded-lg bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 flex items-center justify-center font-bold text-xs">
                  A
                </div>
                <div className="truncate">
